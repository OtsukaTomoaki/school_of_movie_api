class Movies < ActiveRecord::Migration[7.0]
  def change
    create_table :movies, id: false do |t|
      ...
      t.string :poster_path, limit: 255, null: true, comment: 'ポスター画像パス'
      t.string :backdrop_path, limit: 255, null: true, comment: '背景画像パス'
      ...
      t.datetime :release_date, null: true, comment: '公開日'
